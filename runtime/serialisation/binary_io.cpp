...
void write_uint32(std::ostream& os, std::int32_t x) { os.write(as_char_ptr(&x), sizeof x); }

void write_uint64(std::ostream& os, std::int64_t x) { os.write(as_char_ptr(&x), sizeof x); }
